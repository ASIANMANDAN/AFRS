...
/**
 *  Makes Airports using the FAA website. This is meant to be used in the
 *
 * @author Elijah Cantella - edc8230@rit.edu
 * @author Dan Wang - dcw2772@rit.edu
 */
public class OnlineAirports {

    public Airport makeAirport(String code) {
        String[] airportInfo = this.getAirport(code);
        Airport airport = new Airport(code, airportInfo[1]);
        return airport;
    }
